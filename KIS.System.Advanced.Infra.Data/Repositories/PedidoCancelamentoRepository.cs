...
{
    public class PedidoCancelamentoRepository : RepositoryBase<PedidoCancelamento>, IPedidoCancelamentoRepository
    {
        public PedidoCancelamentoRepository(ProjetoDataContext db = null) : base(db)
        {
